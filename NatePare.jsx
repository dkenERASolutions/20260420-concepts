...
function useToggle( inital = false) {
    const [on, setOn] = useState(inital);
...
// Custom hook - use Local Storage (this state survives a refresh)
function useLocalStorage( key, defaultValue ) {
    const [ value, setValue] = useState( () => {
        const stored = localStorage.getItem(key);
        return stored !== null ? JSON.parsed(stored) : defaultValue;
    });
